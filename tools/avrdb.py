    ...
    def check_db(self):
        try:
            self.cursor.execute('''CREATE TABLE uC
                        ...
                        EEPROM    UNSIGNED SMALLINT NOT NULL)''')
        except:
            print('Table exists...')
        ...
        if mode == 1:
            ...
            while True:
                ...
                if boot + a.bootsize - 1 > flash:
                    ...
                    print("\nEEPROM should be a multipliet of SPM_BUFFSIZE")
                else:
                    break
            a.id = sig
            ...
            if not a.exist():
                ...
                while True:
                    while True:
                        try:
                            spm = int(input("Enter SPM buffer size "
                                            "(decimal): "))
                        except ValueError:
                            print("Value incorrect")
                        else:
                    ...
                    if boot + a.bootsize - 1 > flash:
                        ...
                        print("\nFLASHEND should be a multiplier of "
                              "SPM_BUFFSIZE")
                    elif (eeprom + 1) % spm != 0:
                        print("\nEEPROM should be a multiplier of "
                              "SPM_BUFFSIZE")
                    else:
                        break
